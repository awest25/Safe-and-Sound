...
export const generateDangerList = async (reviewList: String[]) => {
    ...
    const prompt = "The following are reviews about a vacation rental. For every potential health or safety hazard mentioned in a review, return a short description of the hazard that a guest should be aware of before booking the rental. Every hazard should be separated by a line break. If there are more than 3 hazards, choose the three most important ones. If there are no hazards, return the phrase \"There are no reported hazards.\" Here are the reviews:";
